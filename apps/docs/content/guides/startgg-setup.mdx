...
> **Note:** OAuth callbacks require publicly accessible URLs. For local development with OAuth, use [Cloudflare Tunnel](/fightrise-bot/guides/tunnel-setup/) to expose your local server.
...
See the [GitHub Issues](https://github.com/wukrit/issues) to track progress or find ways to contribute.
